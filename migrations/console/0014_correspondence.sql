...
CREATE TABLE IF NOT EXISTS co_parties (
  id           INTEGER PRIMARY KEY AUTOINCREMENT,
  name         TEXT    NOT NULL UNIQUE,
  kind         TEXT    NOT NULL DEFAULT 'client',   client_code  TEXT,
  tin          TEXT,
  contact_name TEXT,
  email        TEXT,
  phone        TEXT,
...
CREATE TABLE IF NOT EXISTS co_letters (
  ...
  priority        TEXT    NOT NULL DEFAULT 'normal',   channel         TEXT,
    their_ref       TEXT,
    letter_date     TEXT,
  received_at     TEXT,
  dispatched_at   TEXT,
...
CREATE TABLE IF NOT EXISTS co_recipients (
  ...
  kind      TEXT    NOT NULL DEFAULT 'to',   party_id  INTEGER REFERENCES co_parties (id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS co_letter_links (
  ...
  kind      TEXT    NOT NULL DEFAULT 'related',   at        TEXT    NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS co_workflow_steps (
  ...
  name                  TEXT    NOT NULL,
  action                TEXT    NOT NULL DEFAULT 'action',         to_user_id            INTEGER REFERENCES users (id) ON DELETE SET NULL,
  to_department_id      INTEGER REFERENCES co_departments (id) ON DELETE SET NULL,
  to_permission         TEXT,
