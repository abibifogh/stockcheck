...
export const api = {
  ...
  toolHistory: (id) => request(`/api/tools/${id}/history`),
  issueTool: (id, body) => request(`/api/tools/${id}/issue`, { method: 'POST', body }),
  returnTool: (id, body) => request(`/api/tools/${id}/return`, { method: 'POST', body }),
  createTool: (body) => request('/api/tools', { method: 'POST', body }),
  updateTool: (id, body) => request(`/api/tools/${id}`, { method: 'PUT', body }),
  retireTool: (id) => request(`/api/tools/${id}`, { method: 'DELETE' }),
